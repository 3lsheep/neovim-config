...
function M.on_attach(client, bufnr)
	...
	map('<space>fd', 'vim.diagnostic.open_float()')
...
function M.enable_format_on_save()
    ...
    augroup format_on_save
      au!
      au BufWritePre * lua vim.lsp.buf.format(nil, 2000)
    augroup end
  ]]
end
...
vim.cmd [[command! LspToggleVirtualText execute 'lua require("lsp.handlers").toggle_virtual_text()']]
